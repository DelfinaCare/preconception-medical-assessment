    ...
    container.innerHTML = `
      <div class="prema-container">
        ...
        <div class="logo-placeholder">
          This quiz was developed by the <a href="https://osg.ca.gov/maternal-health-resources/">Office of the California Surgeon General</a> <img src="https://delfinacare.github.io/preconception-medical-assessment/proprietary_logos/ca_osg.png" alt="logo of the Office of the CA Surgeon General logo" class="prema-logo-img" /> and <a href="https://github.com/DelfinaCare/preconception-medical-assessment" target="_blank">open sourced</a> with &#10084; by <a href="https://delfina.com" target="_blank">Delfina</a> <img src="https://delfinacare.github.io/preconception-medical-assessment/proprietary_logos/delfina.png" alt="Delfina logo" class="prema-logo-img" />. This is not a substitute for medical advice.
        </div>
      </div>
    `;
